...
# Install fonts
###############################################################################
# Install fonts in system folder
font_path="/Library/Fonts/"
# Install Source Code Pro
# Install Source Sans Pro
echo "Installing Google Fonts"
mkdir -p /tmp/goog-fonts/fonts
cd /tmp/goog-fonts/fonts
echo "Downloading Source Code Pro"
svn export https://github.com/google/fonts/trunk/ofl/sourcecodepro
echo "Downloading Source Sans Pro"
svn export https://github.com/google/fonts/trunk/ofl/sourcesanspro
